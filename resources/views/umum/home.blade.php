                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="alert alert-success">
                                    <H3>Sistem Pakar Diagnosa Malnutrisi Pada Balita</H3>
                                ...
                                . Program aplikasi ini menganalisa data penyakit malnutrisi, anamnesis awal serta gejala-gejala dari suatu penyakit.
                        </p>
                        <a href="{{route('konsultasi')}}"><i>MULAI DIAGNOSA</i></a>
                        </div>
